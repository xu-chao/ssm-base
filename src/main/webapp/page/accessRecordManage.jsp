...
<%--            src="${pageContext.request.contextPath}/static/jquery-easyui-1.3.3/datagrid-detailview.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function exportAccessRecord(){
            ...
            // 下载文件
            $.download("${pageContext.request.contextPath }/accessRecord/accessRecordExport", formData);
        }
        ...
        $(document).ready(function () {
            ...
            $('#dg').datagrid({
                ...
                //singleSelect:true,
                nowrap:false,
                url: '${pageContext.request.contextPath}/accessRecord/accessRecordPage',
                columns: [[
                    ...
                    {field: 'access_Type', title: '登录类型', width: 100, align: 'center'},
                    {
                        field: 'access_Time', title: '操作时间', width: 100, align: 'center',sortable:true,
                        formatter: function (val, row, index) {
                            var now = new Date(val);
                            return now.format("Y-m-d H:i:s");
                        }
                    },
                    {field: 'access_IP', title: '登录IP', width: 100, align: 'center'}
                ]],
                // queryParams:{},
                pageSize:20,
...
<div id="tb">
    <div>
        ...
        <a href="javascript:exportAccessRecord()" class="easyui-linkbutton" iconCls="icon-excel" plain="true">导出</a>
    </div>
</div>

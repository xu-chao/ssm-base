            ...
            var uploaderExists = $("#uploaderExists").pluploadQueue($.extend({
                ...
                init: {
                    ...
                    BeforeUpload: function (uploaderExists, file) {
                        ...
                        var urlStr = pageContext + "/fileInfo/uploadFile?fileID=" + editFileID;
    ...
    <form id="fm" method="post">
        <table style="margin:5px;height:100px;">
            ...
            <tr>
                <td>改造时间：</td>
                <td>
                    <input class="easyui-datetimebox" style="width:300px;" type="text" id="gzDate"
                           data-options="panelHeight:'auto'" name="gzDate" required="true"/>
                </td>
            </tr>
            <tr>

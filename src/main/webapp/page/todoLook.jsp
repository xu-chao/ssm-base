...
<head>
	...
	<script type="text/javascript">
		...
		function submit(state) {
			$("#fm").form("submit", {
				url: '${pageContext.request.contextPath}/repairTask/auditOperationalManagers?state=' + state,
				onSubmit: function () {
		...
		function openUpFile() {
			...
			$('#findFiles').datagrid({
				...
				striped: true,
				nowrap: false,
				url: '${pageContext.request.contextPath}/fileInfo/findFiles?fileID=' + repairFileID,
				columns: [[
					{field: 'cb', checkbox: true, align: 'center'},
...
<div data-options="region:'center',title:'运营管理人员查阅'"
		...
		<form id="fm" method="post">
			<table class="table table-border table-bordered table-striped" style="width: 100%">
				...
				<tr>
					...
					<td colspan="4">
						<a href="javascript:submit(1)" class="easyui-linkbutton" iconCls="icon-ok">已查阅</a>
						&nbsp;&nbsp;

...
<head>
    ...
    <script type="text/javascript">
        function startRedictApply() {
            ...
            //     },
            // });
            var validate =$('#yinxiang').form('validate')
        if (!validate){
            $.messager.alert("系统提示","请填写完必要字段！");
            return;
        }
            var formData = $('#yinxiang').serializeJSON();
            $.ajax({
                url: '${pageContext.request.contextPath}/touYing/addTouYing',
                data: formData,
                dataType: 'json',
                type: 'post',
        ...
        function closeDialog(){
            window.parent.refreshTabData("填写投影设备安装条件检查表",window.top.reload_touYing);
        }

        $(document).ready(function () {
            $('#touYing_date').datetimebox({
                required: true,
                showSeconds: true,
                editable: false,
            });
                ...
                <tr style="height:19.8500pt;page-break-inside:avoid;">
                    ...
                    <td width=296 valign=center colspan=3
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                ...
                                style="mso-spacerun:'yes';font-family:宋体;font-size:12.0000pt;">---自动生成---</span><span
                                style="font-family:宋体;font-size:12.0000pt;"><o:p></o:p></span></p></td>
                </tr>
...
<%----------------------------------------------工程名称--%>
                        <input class="easyui-validatebox" id="project_name" name="project_name" maxlength="30" required="true"
                               style="width:360px; height:35px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                    </span><span
                                style="font-family:宋体;font-size:12.0000pt;"><o:p></o:p></span></p></td>
                ...
                <tr style="height:19.8500pt;page-break-inside:avoid;">
                    ...
                    <td width=312 valign=center colspan=3
                        ...
                        <p class=MsoNormal align=center style="margin-bottom:0.0000pt;text-align:center;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:12.0000pt;">
<%----------------------------------------------项目名称--%>
                        <input class="easyui-validatebox" id="entry_name" required="true" name="entry_name" maxlength="30"
                               style="width:360px; height:35px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                        </span><span
                                style="font-family:宋体;font-size:12.0000pt;"><o:p></o:p></span></p></td>
 ...
 <%---------------------------------------------- 时间 --%>
                        ...
                        <input type="text" id="touYing_date" style="width:200px;" required="true"
                               name="touYing_date" class="easyui-validatebox"/></a>
                         </span><span
                                style="font-family:宋体;font-size:12.0000pt;"><o:p></o:p></span></p></td>
                </tr>
                <tr style="height:19.8500pt;page-break-inside:avoid;">
                    <td width=53 valign=center
                        style="width:38.3000pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:1.0000pt solid rgb(0,0,0);mso-border-left-alt:0.5000pt solid rgb(0,0,0);border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid rgb(0,0,0);border-bottom:1.0000pt solid rgb(0,0,0);mso-border-bottom-alt:0.5000pt solid rgb(0,0,0);">
                        <p class=MsoNormal align=center style="margin-bottom:0.0000pt;text-align:center;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">序号</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=57 valign=center colspan=2
                        style="width:27.7500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid rgb(0,0,0);mso-border-right-alt:0.5000pt solid rgb(0,0,0);border-top:none;mso-border-top-alt:0.5000pt solid rgb(0,0,0);border-bottom:1.0000pt solid rgb(0,0,0);mso-border-bottom-alt:0.5000pt solid rgb(0,0,0);">
                        <p class=MsoNormal align=center style="margin-bottom:0.0000pt;text-align:center;"><span
                    ...
                    <td width=75 valign=center
                        style="width:86.8500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid rgb(0,0,0);mso-border-right-alt:0.5000pt solid rgb(0,0,0);border-top:none;mso-border-top-alt:0.5000pt solid rgb(0,0,0);border-bottom:1.0000pt solid rgb(0,0,0);mso-border-bottom-alt:0.5000pt solid rgb(0,0,0);">
                        <p class=MsoNormal align=center style="margin-bottom:0.0000pt;text-align:center;"><span
                                ...
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=84 valign=center
                        style="width:83.5500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid rgb(0,0,0);mso-border-right-alt:0.5000pt solid rgb(0,0,0);border-top:1.0000pt solid rgb(0,0,0);mso-border-top-alt:0.5000pt solid rgb(0,0,0);border-bottom:1.0000pt solid rgb(0,0,0);mso-border-bottom-alt:0.5000pt solid rgb(0,0,0);">
                        <p class=MsoNormal align=center style="margin-bottom:0.0000pt;text-align:center;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">检验</span><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">结果</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=141 valign=center
                        style="width:186.3500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:1.0000pt solid rgb(0,0,0);mso-border-top-alt:0.5000pt solid rgb(0,0,0);border-bottom:1.0000pt solid rgb(0,0,0);mso-border-bottom-alt:0.5000pt solid rgb(0,0,0);">
                        <p class=MsoNormal align=center style="margin-bottom:0.0000pt;text-align:center;"><span
        ...
        <p class=MsoNormal><span
                style="mso-spacerun:'yes';font-family:Tahoma;font-size:11.0000pt;"><o:p>&nbsp;</o:p></span>
        </p></div>
    <div class="Section0" style="layout-grid:18.0000pt;">
        <div align=center>
            <table class=MsoNormalTable border=1 cellspacing=0
...
<%----------------------------------------------合格1--%>
                         <input class="easyui-validatebox" type="radio" name="n1_flag" value="1" checked="checked" validType="radio['frm','n1_flag']"/>
                        </span>
                            <span style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span>
<%----------------------------------------------不合格1--%>
                        <input class="easyui-validatebox" type="radio" name="n1_flag" value="0">
                    </span>
                    ...
                    <td width=142 valign=center
                        ...
                        <p class=MsoPlainText style="text-align:left;">
                            <span style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                                <%---------------------------------------------- n1_text --%>
                                <input class="easyui-textbox" id="n1_text" name="n1_text"
                                       data-options="multiline:true,validType:'length[1,100]'"
                                       style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                            </o:p></span>
                        </p>
                    </td>
...
<%---------------------------------------------- 合格2 --%>
                         <input type="radio" name="n2_flag" value="1" checked="checked"  class="easyui-validatebox" validType="radio['frm','n2_flag']">合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
<%---------------------------------------------- 不合格2 --%>
                         <input type="radio" class="easyui-validatebox" name="n2_flag" value="0">不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        ...
                        <p class=MsoPlainText style="text-align:left;"><span
                            ...
                            <o:p>
                                <%---------------------------------------------- n2_text --%>
                                <input class="easyui-textbox" id="n2_text" name="n2_text"
                                       data-options="multiline:true,validType:'length[1,100]'"
                                       style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                            </o:p></span>
                ...
                <tr style="height:23.9000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                            ...
                            <%---------------------------------------------- 合格3 --%>
                         <input type="radio" name="n3_flag" value="1" checked="checked" class="easyui-validatebox" validType="radio['frm','n3_flag']">
                        </span><span
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="font-family:宋体;font-size:10.5000pt;">
                            <%---------------------------------------------- 不合格3 --%>
                         <input type="radio" name="n3_flag" value="0" class="easyui-validatebox"></span><span
                    ...
                    <td width=142 valign=center
                        ...
                        <p class=MsoPlainText style="text-align:left;"><span
                            ...
                            <%---------------------------------------------- n3_text --%>
                            <input class="easyui-textbox" id="n3_text" name="n3_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
              <%---------------------------------------------- 合格4 --%>
                         <input type="radio" name="n4_flag" value="1" checked="checked" class="easyui-validatebox"
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
              <%---------------------------------------------- 不合格4 --%>
                         <input type="radio" name="n4_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n4_text --%>
                            <input class="easyui-textbox" id="n4_text" name="n4_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
    <%---------------------------------------------- 合格5 --%>
                         <input type="radio" name="n5_flag" value="1" checked="checked" class="easyui-validatebox" validType="radio['frm','n5_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                            <%---------------------------------------------- 不合格5 --%>
                         <input type="radio" name="n5_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n5_text --%>
                            <input class="easyui-textbox" id="n5_text" name="n5_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:30.5000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                       <%---------------------------------------------- 合格6 --%>
                         <input type="radio" name="n6_flag" value="1" checked="checked" class="easyui-validatebox" validType="radio['frm','n6_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                <%---------------------------------------------- 不合格6 --%>
                         <input type="radio" name="n6_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n6_text --%>
                            <input class="easyui-textbox" id="n6_text" name="n6_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                             <%---------------------------------------------- 合格7 --%>
                         <input type="radio" name="n7_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n7_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
<%---------------------------------------------- 不合格7 --%>
                         <input type="radio" name="n7_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(0,255,255);mso-highlight:rgb(0,255,255);"><o:p>
                            <%---------------------------------------------- n7_text --%>
                            <input class="easyui-textbox" id="n7_text" name="n7_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                     <%---------------------------------------------- 合格8 --%>
                         <input type="radio" name="n8_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n8_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                   <%---------------------------------------------- 不合格8 --%>
                         <input type="radio" name="n8_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(0,255,255);mso-highlight:rgb(0,255,255);"><o:p>
                            <%---------------------------------------------- n8_text --%>
                            <input class="easyui-textbox" id="n8_text" name="n8_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:28.2000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                          <%---------------------------------------------- 合格9 --%>
                         <input type="radio" name="n9_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n9_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                  <%---------------------------------------------- 不合格9 --%>
                         <input type="radio" name="n9_flag" value="0" class="easyui-validatebox" >
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n9_text --%>
                            <input class="easyui-textbox" id="n9_text" name="n9_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                            ...
                            <%---------------------------------------------- 合格10 --%>
                            <input type="radio" name="n10_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n10_flag']">
                            合格 </o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                  <%---------------------------------------------- 不合格10 --%>
                         <input type="radio" name="n10_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    </td>
                    <td width=142 valign=center
                        ...
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n10_text --%>
                            <input class="easyui-textbox" id="n10_text" name="n10_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:25.7000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                            <%---------------------------------------------- 合格11 --%>
                         <input type="radio" name="n11_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n11_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                    <%---------------------------------------------- 不合格10 --%>
                         <input type="radio" name="n11_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n11_text --%>
                            <input class="easyui-textbox" id="n11_text" name="n11_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:28.0000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                           <%---------------------------------------------- 合格12 --%>
                         <input type="radio" name="n12_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n12_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                     <%---------------------------------------------- 不合格12 --%>
                         <input type="radio" name="n12_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n12_text --%>
                            <input class="easyui-textbox" id="n12_text" name="n12_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:24.8500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                 <%---------------------------------------------- 合格13 --%>
                         <input type="radio" name="n13_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n13_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                <%---------------------------------------------- 不合格13 --%>
                         <input type="radio" name="n13_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n13_text --%>
                            <input class="easyui-textbox" id="n13_text" name="n13_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:21.1000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                              <%---------------------------------------------- 合格14 --%>
                         <input type="radio" name="n14_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n14_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                  <%---------------------------------------------- 不合格14 --%>
                         <input type="radio" name="n14_flag" value="0" class="easyui-validatebox" >
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n14_text --%>
                            <input class="easyui-textbox" id="n14_text" name="n14_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                <%---------------------------------------------- 合格15 --%>
                         <input type="radio" name="n15_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n15_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                               <%---------------------------------------------- 不合格15 --%>
                         <input type="radio" name="n15_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n15_text --%>
                            <input class="easyui-textbox" id="n15_text" name="n15_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                              <%---------------------------------------------- 合格16 --%>
                         <input type="radio" name="n16_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n16_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                               <%---------------------------------------------- 不合格16 --%>
                         <input type="radio" name="n16_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n16_text --%>
                            <input class="easyui-textbox" id="n16_text" name="n16_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                   <%---------------------------------------------- 合格17 --%>
                         <input type="radio" name="n17_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n17_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                 <%---------------------------------------------- 不合格17 --%>
                         <input type="radio" name="n17_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n17_text --%>
                            <input class="easyui-textbox" id="n17_text" name="n17_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                                <%---------------------------------------------- 合格18 --%>
                         <input type="radio" name="n18_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n18_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                       <%---------------------------------------------- 不合格18 --%>
                         <input type="radio" name="n18_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n18_text --%>
                            <input class="easyui-textbox" id="n18_text" name="n18_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:25.6000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                      <%---------------------------------------------- 合格19 --%>
                         <input type="radio" name="n19_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n19_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                 <%---------------------------------------------- 不合格19 --%>
                         <input type="radio" name="n19_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n19_text --%>
                            <input class="easyui-textbox" id="n19_text" name="n19_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.1500pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                             <%---------------------------------------------- 合格20 --%>
                         <input type="radio" name="n20_flag" value="1" checked="checked" class="easyui-validatebox"   validType="radio['frm','n20_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                       <%---------------------------------------------- 不合格20 --%>
                         <input type="radio" name="n20_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n20_text --%>
                            <input class="easyui-textbox" id="n20_text" name="n20_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:27.3000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                      <%---------------------------------------------- 合格21 --%>
                         <input type="radio" name="n21_flag" value="1" checked="checked" class="easyui-validatebox" validType="radio['frm','n21_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                   <%---------------------------------------------- 不合格21 --%>
                         <input type="radio" name="n21_flag" value="0" class="easyui-validatebox">
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n21_text --%>
                            <input class="easyui-textbox" id="n21_text" name="n21_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:23.5000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                        <%---------------------------------------------- 合格22 --%>
                         <input type="radio" name="n22_flag" value="1" checked="checked" class="easyui-validatebox" validType="radio['frm','n22_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                        <%---------------------------------------------- 不合格22 --%>
                         <input type="radio" name="n22_flag" value="0" class="easyui-validatebox" >
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n22_text --%>
                            <input class="easyui-textbox" id="n22_text" name="n22_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:25.4000pt;">
                    ...
                    <td width=85 valign=center
                        ...
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                             <%---------------------------------------------- 合格23 --%>
                         <input type="radio" name="n23_flag" value="1" checked="checked" class="easyui-validatebox" validType="radio['frm','n23_flag']">
                            合格 </span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p>
                        <p class=MsoNormal style="margin-bottom:0.0000pt;"><span
                                style="mso-spacerun:'yes';font-family:宋体;font-size:10.5000pt;">
                        <%---------------------------------------------- 不合格23 --%>
                         <input type="radio" name="n23_flag" value="0" class="easyui-validatebox" >
                            不合格</span><span
                                style="font-family:宋体;font-size:10.5000pt;"><o:p></o:p></span></p></td>
                    <td width=142 valign=center
                        style="width:106.9500pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;mso-border-left-alt:none;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;">
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- n23_text --%>
                            <input class="easyui-textbox" id="n23_text" name="n23_text"
                                   data-options="multiline:true,validType:'length[1,100]'"
                                   style="width:238px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                ...
                <tr style="height:31.5000pt;">
                    ...
                    <td width=538 valign=center colspan=4
                        ...
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- 结论 --%>
                            <input class="easyui-textbox" id="jieLun_text" name="jieLun_text"
                                   data-options="multiline:true,validType:'length[1,200]'"
                                   style="width:638px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                        </o:p></span>
                        </p></td>
                </tr>
                <tr style="height:34.8000pt;">
                    ...
                    <td width=538 valign=center colspan=4
                        ...
                        <p class=MsoPlainText style="text-align:left;"><span
                                style="font-family:宋体;font-size:10.5000pt;mso-font-kerning:1.0000pt;"><o:p>
                            <%---------------------------------------------- 其他 --%>
                            <input class="easyui-textbox" id="other_text" name="other_text"
                                   data-options="multiline:true,validType:'length[1,200]'"
                                   style="width:638px; height:100px;border-left-width:0px;
                                border-top-width:0px;border-right-width:0px;border-bottom-color:black;outline: none;">
                        </o:p></span>

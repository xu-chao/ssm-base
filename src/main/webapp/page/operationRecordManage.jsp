...
<%--    <script type="text/javascript">--%>
<%--        &lt;%&ndash;用于search.js自动补全${pageContext.request.contextPath}/operationRecord/operationRecordPage.action&ndash;%&gt;--%>
<%--        var _url = '${pageContext.request.contextPath}/operationRecord/searchoperationRecordName';--%>
<%--        var _value = '';--%>
<%--        //用于crud.js的esayui初始参数--%>
<%--        var name = "${pageContext.request.contextPath}/operationRecord/operationRecord";--%>
<%--        var title = '系统日志管理';--%>
<%--        var idField = 'record_ID';--%>
<%--        var height = 300;--%>
<%--        var width = 300;--%>
<%--        var columns = [[--%>
...
<%--    </script>--%>
    <script type="text/javascript">
        ...
        function exportOperationRecord(){
            var formData = {
                "userID": id,
                "startDate": startDate,
                "endDate": endDate
            ...
            // 下载文件
            $.download("${pageContext.request.contextPath }/operationRecord/operationRecordExport", formData);
        }
...
<div id="tb">
    <div>
        ...
        <a href="javascript:exportOperationRecord()" class="easyui-linkbutton" iconCls="icon-excel" plain="true">导出</a>
    </div>
</div>

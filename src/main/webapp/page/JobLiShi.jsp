...
<head>
    ...
    <shiro:hasAnyRoles name="HYSexaminer">
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/base/huiyishi/huiyishiLiShi.js"></script>
    </shiro:hasAnyRoles>
    ...
    <shiro:hasAnyRoles name="PTAVManager,PTSupervisor,PTScene,PTEngineer">
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/base/planTask/planTaskLiShi.js"></script>
    </shiro:hasAnyRoles>
</head>
<body style="margin: 1px">
<table id="dg" title="历史任务管理"

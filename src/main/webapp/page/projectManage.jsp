...
<head>
    ...
    <script type="text/javascript">
        //用于search.js自动补全
        var _url = '${pageContext.request.contextPath}/project/searchAllProject';
        var _idName = '项目ID';
        var _value = 'projectName';
        //用于crud.js的esayui初始参数
        var root = "${pageContext.request.contextPath}/project/";
        var pageName = 'project';
        var name = 'Project';
        var title = '项目列表';
        var idField = 'projectID';
...
<div data-options="region:'north',title:'查询'"
    ...
    <form id="searchForm">
        <table cellpadding="5">
            <tr>
                <td>项目名称 ：</td>
                <td><input name="projectName" class="easyui-combobox" id="inputtable" /></td>
    ...
    <form id="editForm">
        <table>
            <tr>
                <td>所属城市：</td>
                <td>
                    <input id="cityName" name="Park.City.cityID" class="easyui-combobox" data-options="required:true,missingMessage:'城市名称不能为空!'">
                </td>
            </tr>
            <tr>
                <td>公园名称：</td>
